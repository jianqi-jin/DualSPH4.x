...
inline const char *TmcGetName(CsTypeTimerCPU ct) {
    switch (ct) {
        ...
        case TMC_NlOutCheck:
            return ("NL-OutCheck");
        case TMC_CfPreForces:
            return ("CF-PreForces");
        case TMC_CfForces:
            return ("CF-Forces");
        case TMC_SuShifting:
            return ("SU-Shifting");
        case TMC_SuComputeStep:
            return ("SU-ComputeStep");
        case TMC_SuFloating:
            return ("SU-Floating");
        case TMC_SuMotion:
            return ("SU-Motion");
...
//==============================================================================
inline void
TmcIncreaseValue(TimersCpu vtimer, CsTypeTimerCPU ct, double value) { if (vtimer[ct].active)vtimer[ct].time += value; }
...
//==============================================================================
inline bool TmcIsActive(const TimersCpu vtimer, CsTypeTimerCPU ct) {
    return (unsigned(ct) < TmcGetCount() && vtimer[ct].active);
}

//==============================================================================
/// Activates a given timer.
//==============================================================================
inline void TmcActive(TimersCpu vtimer, CsTypeTimerCPU ct, bool active) {
    if (unsigned(ct) < TmcGetCount())
        vtimer[ct].active = active;
}

//==============================================================================
/// Activates o deactivates all timers.
//==============================================================================
inline void TmcActiveAll(TimersCpu vtimer, bool active) {
    for (unsigned c = 0; c < TMC_COUNT; c++)
        vtimer[c].active = active;
}
